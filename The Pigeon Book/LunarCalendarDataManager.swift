...
class LunarCalendarDataManager {
    ...
    // ✅ 支援的年份範圍
    private let supportedYears = [2025, 2026]
    ...
    // ✅ 按年份組織的資料
    private lazy var calendarData: [Int: [String: LunarCalendarData]] = {
        var data: [Int: [String: LunarCalendarData]] = [:]
        
        // 2025 年資料
        data[2025] = load2025Data()
        
        // 2026 年資料
        data[2026] = load2026Data()
    ...
    func getData(for date: Date) -> LunarCalendarData {
        ...
        return calendarData[year]?[dateKey] ?? defaultData
    }
    ...
    func hasData(for date: Date) -> Bool {
        ...
        return calendarData[year]?[dateKey] != nil
    }
    
    /// 獲取特定年份所有已設定資料的日期
    /// - Parameter year: 年份
    /// - Returns: 該年份所有有資料的日期字串陣列 (MM-dd 格式)
    func getAllAvailableDates(for year: Int) -> [String] {
        guard let yearData = calendarData[year] else {
            return []
        }
        return Array(yearData.keys).sorted()
    }
    ...
    /// 檢查是否支援特定年份
    /// - Parameter year: 要檢查的年份
    /// - Returns: 是否支援該年份
    func isYearSupported(_ year: Int) -> Bool {
    ...
    /// 載入 2025 年資料
    private func load2025Data() -> [String: LunarCalendarData] {
        return [
    ...
    /// 載入 2026 年資料
    private func load2026Data() -> [String: LunarCalendarData] {
        return [
            "01-01": LunarCalendarData(
                lunarTerm: "十三",
                suitableActivities: "宜入宅、移徙",
                unsuitableActivities: "忌嫁娶、開市",
                idiom: "六六大順",
                idiomDescription: "形容事事順利，無所阻礙。",
                idiomImageName: "2026_day001"
            ),

            "01-02": LunarCalendarData(
                lunarTerm: "十四",
                suitableActivities: "宜畜稠、馴畜",
                unsuitableActivities: "忌入宅、移徙",
                idiom: "旗開得勝",
                idiomDescription: "比喻事情才一開始就獲得成功。",
                idiomImageName: "2026_day002"
            ),

            "01-03": LunarCalendarData(
                lunarTerm: "十五",
                suitableActivities: "宜訂盟、納采",
                unsuitableActivities: "忌破土、安葬",
                idiom: "當頭棒喝",
                idiomDescription: "比喻為一種使人立即醒悟的強烈警示。",
                idiomImageName: "2026_day003"
            ),

            "01-04": LunarCalendarData(
                lunarTerm: "十六",
                suitableActivities: "宜訂盟、納采",
                unsuitableActivities: "忌祈福、出火",
                idiom: "遠走高飛",
                idiomDescription: "離開故鄉而遠行，大多指為避禍或忽然發憤想要有所為的行動而言。",
                idiomImageName: "2026_day004"
            ),

            "01-05": LunarCalendarData(
                lunarTerm: "小寒",
                suitableActivities: "宜開市、交易",
                unsuitableActivities: "忌修造、上樑",
                idiom: "旁門左道",
                idiomDescription: "指不正派的學術流派或宗教派別。也泛指不正經的東西、不正派的事物。",
                idiomImageName: "2026_day005"
            ),

            "01-06": LunarCalendarData(
                lunarTerm: "十八",
                suitableActivities: "宜解除",
                unsuitableActivities: "忌祭祀、入宅",
                idiom: "當世無雙",
                idiomDescription: "當代獨一無二，首屈一指。",
                idiomImageName: "2026_day006"
            ),

            "01-07": LunarCalendarData(
                lunarTerm: "十九",
                suitableActivities: "宜嫁娶、祈福",
                unsuitableActivities: "忌掘井、栽種",
                idiom: "落井下石",
                idiomDescription: "比喻乘人危難時，加以陷害。語本唐．韓愈〈柳子厚墓誌銘〉。",
                idiomImageName: "2026_day007"
            ),

            "01-08": LunarCalendarData(
                lunarTerm: "廿十",
                suitableActivities: "宜嫁娶、開光",
                unsuitableActivities: "忌出行、開市",
                idiom: "一帆風順",
                idiomDescription: "比喻旅程或事情進行得非常順利，沒有阻礙，就像一艘船揚起帆後順風前進。",
                idiomImageName: "2026_day008"
            ),
            ...
            "01-09": LunarCalendarData(
                ...
                idiom: "一無是處",
                idiomDescription: "沒有一點正確或值得肯定的地方。",
                idiomImageName: "2026_day009"
            ),

            "01-10": LunarCalendarData(
                lunarTerm: "廿二",
                suitableActivities: "宜嫁娶、開市",
                unsuitableActivities: "忌安床、伐木",
                idiom: "飲水思源",
                idiomDescription: "喝水的時候要想到水的來源。比喻不忘本，常懷感恩之心。",
                idiomImageName: "2026_day010"
            ),
            ...
            "01-12": LunarCalendarData(
                ...
                idiom: "潸然淚下",
                idiomDescription: "眼淚自然地流下來。形容因感動、悲傷或某種強烈情緒而流淚。",
                idiomImageName: "2026_day012"
            ),

            "01-13": LunarCalendarData(
                lunarTerm: "廿五",
                suitableActivities: "宜開市、納財",
                unsuitableActivities: "忌嫁娶、理髮",
                idiom: "橫衝直撞",
                idiomDescription: "形容人或動物不顧一切地亂衝亂撞，動作魯莽、毫無顧忌。",
                idiomImageName: "2026_day013"
            ),

            "01-14": LunarCalendarData(
                lunarTerm: "廿六",
                suitableActivities: "宜安床、交易",
                unsuitableActivities: "忌置產、嫁娶",
                idiom: "高枕無憂",
                idiomDescription: "形容人生活安定、內心毫無憂慮，能安心入睡。",
                idiomImageName: "2026_day014"
            ),
            ...
            "01-15": LunarCalendarData(
                ...
                idiom: "杯水車薪",
                idiomDescription: "一杯水澆救不了車上燃燒的柴薪，比喻力量太小救不了急。",
                idiomImageName: "2026_day015"
            ),

            "01-16": LunarCalendarData(
                lunarTerm: "廿八",
                suitableActivities: "宜沐浴、動土",
                unsuitableActivities: "忌入宅、安門",
                idiom: "一望無際",
                idiomDescription: "一眼望去看不著邊際。形容寬廣、遼闊。",
                idiomImageName: "2026_day016"
            ),

            "01-17": LunarCalendarData(
                lunarTerm: "廿九",
                suitableActivities: "宜嫁娶、出行",
                unsuitableActivities: "忌掘井、祈福",
                idiom: "晶瑩剔透",
                idiomDescription: "形容光亮透明的樣子。",
                idiomImageName: "2026_day017"
            ),
            ...
            "01-18": LunarCalendarData(
                ...
                idiom: "南柯一夢",
                idiomDescription: "形容人生如夢，也形容一場空歡喜。",
                idiomImageName: "2026_day018"
            ),

            "01-19": LunarCalendarData(
                lunarTerm: "十二月",
                suitableActivities: "宜開光、伐木",
                unsuitableActivities: "忌開市、栽種",
                idiom: "不知所雲",
                idiomDescription: "雲：說。不知道說得是些麽。形容說話內容混亂，無法理解。",
                idiomImageName: "2026_day019"
            ),
            ...
            "01-20": LunarCalendarData(
                ...
                unsuitableActivities: "忌伐木、開市",
                idiom: "橫躺豎臥",
                idiomDescription: "躺臥淩亂的樣子。",
                idiomImageName: "2026_day020"
            ),
            ...
            "01-21": LunarCalendarData(
                ...
                unsuitableActivities: "忌月破",
                idiom: "打擦邊球",
                idiomDescription: "借喻某種行為在政策和法規所允許範圍的臨界線上，看上去似乎違反了政策和法規，實際卻剛好在其允許的範圍之內，巧妙地利用合法的外衣來掩飾非法的企圖和行為，以求不觸犯政策和法規而成功。",
                idiomImageName: "2026_day021"
            ),

            "01-22": LunarCalendarData(
                lunarTerm: "初四",
                suitableActivities: "宜安葬、破土",
                unsuitableActivities: "忌祈福、造廟",
                idiom: "相親相愛",
                idiomDescription: "形容人與人之間的良好關係，例如家人、朋友、同學之間。",
                idiomImageName: "2026_day022"
            ),
            ...
            "01-23": LunarCalendarData(
                ...
                idiom: "滴水穿石",
                idiomDescription: "比喻有志者事竟成，只要努力不懈就能夠成功。",
                idiomImageName: "2026_day023"
            ),

            "01-24": LunarCalendarData(
                lunarTerm: "初六",
                suitableActivities: "宜祭祀、納財",
                unsuitableActivities: "忌嫁娶、開市",
                idiom: "井底之蛙",
                idiomDescription: "住在井底的青蛙，比喻見識淺陋的人。",
                idiomImageName: "2026_day024"
            ),

            "01-25": LunarCalendarData(
                lunarTerm: "初七",
                suitableActivities: "宜入學、認養",
                unsuitableActivities: "忌嫁娶、入宅",
                idiom: "登峰造極",
                idiomDescription: "比喻到達最高峰或最高點，也形容學問、技能等達到精通的最高境界。",
                idiomImageName: "2026_day025"
            ),

            "01-26": LunarCalendarData(
                lunarTerm: "初八",
                suitableActivities: "宜祭祀、祈福",
                unsuitableActivities: "忌入宅、置產",
                idiom: "年年有餘",
                idiomDescription: "每年都有盈餘，生活富足，不虞匱乏。",
                idiomImageName: "2026_day026"
            ),
            ...
            "01-27": LunarCalendarData(
                ...
                unsuitableActivities: "忌季月紅紗",
                idiom: "白雲蒼狗",
                idiomDescription: "蒼：灰白色。浮雲象白衣裳，頃刻又變得象蒼狗。比喻事物變化不定。",
                idiomImageName: "2026_day027"
            ),

            "01-28": LunarCalendarData(
                lunarTerm: "初十",
                suitableActivities: "宜嫁娶、開光",
                unsuitableActivities: "忌作灶、探病",
                idiom: "海綿寶寶",
                idiomDescription: "是一個無知、神經質、不成熟、活潑、快樂的角色，且會不惜一切完成任務。",
                idiomImageName: "2026_day028"
            ),

            "01-29": LunarCalendarData(
                lunarTerm: "十一",
                suitableActivities: "宜出行、納財",
                unsuitableActivities: "忌入宅、祈福",
                idiom: "一擲千金",
                idiomDescription: "形容不吝惜錢財，任意揮霍，花費大量金錢。",
                idiomImageName: "2026_day029"
            ),

            "01-30": LunarCalendarData(
                lunarTerm: "十二",
                suitableActivities: "宜牧養、動土",
                unsuitableActivities: "忌開光、嫁娶",
                idiom: "說走就走",
                idiomDescription: "當一個人有了想法或計畫，不需要太多準備或考慮，立即就付諸行動，立刻開始進行。",
                idiomImageName: "2026_day030"
            ),

            "01-31": LunarCalendarData(
                lunarTerm: "十三",
                suitableActivities: "宜嫁娶、會友",
                unsuitableActivities: "忌開市、出行",
                idiom: "從從容容",
                idiomDescription: "鎮定沉著、不慌不忙，形容人或事情處理得從容不迫、很從容。",
                idiomImageName: "2026_day031"
            ),

            "02-01": LunarCalendarData(
                lunarTerm: "十四",
                suitableActivities: "宜沐浴、捕捉",
                unsuitableActivities: "忌正四廢",
                idiom: "隨波逐流",
                idiomDescription: "順著水流而行。比喻人沒有確定的方向和目標，只依從環境潮流行事。",
                idiomImageName: "2026_day032"
            ),
            ...
            "02-02": LunarCalendarData(
                ...
                idiom: "樂極生悲",
                idiomDescription: "歡樂到了極點，往往會轉生悲哀。",
                idiomImageName: "2026_day033"
            ),

            "02-03": LunarCalendarData(
                lunarTerm: "十六",
                suitableActivities: "宜出貨、開市",
                unsuitableActivities: "忌四離",
                idiom: "財運亨通",
                idiomDescription: "亨：通達，順利。發財的運道好，賺錢很順利。",
                idiomImageName: "2026_day034"
            ),
            ...
            "02-05": LunarCalendarData(
                ...
                idiom: "樹大招風",
                idiomDescription: "比喻一個人名聲太大或地位太高，容易招致別人的嫉妒、批評或陷害。",
                idiomImageName: "2026_day036"
            ),

            "02-06": LunarCalendarData(
                lunarTerm: "十九",
                suitableActivities: "宜移徙、認養",
                unsuitableActivities: "忌嫁娶、破土",
                idiom: "飛向宇宙",
                idiomDescription: "來自玩具總動員的經典台詞，也說出了許多人對前進太空的未來嚮往。",
                idiomImageName: "2026_day037"
            ),
            ...
            "02-07": LunarCalendarData(
                ...
                idiom: "浩瀚無垠",
                idiomDescription: "形容水勢或地域廣大遼闊，沒有邊際。",
                idiomImageName: "2026_day038"
            ),

            "02-08": LunarCalendarData(
                lunarTerm: "廿一",
                suitableActivities: "宜祭祀、經絡",
                unsuitableActivities: "忌出火、入宅",
                idiom: "一飛沖天",
                idiomDescription: "比喻人一下子成名或事業上升很快。",
                idiomImageName: "2026_day039"
            ),

            "02-09": LunarCalendarData(
                lunarTerm: "廿二",
                suitableActivities: "宜裁衣、伐木",
                unsuitableActivities: "忌開市、出行",
                idiom: "愛屋及烏",
                idiomDescription: "比喻愛一個人而連帶地關心與他有關的人或物。",
                idiomImageName: "2026_day040"
            ),

            "02-10": LunarCalendarData(
                lunarTerm: "廿三",
                suitableActivities: "宜嫁娶、祭祀",
                unsuitableActivities: "忌修造、求財",
                idiom: "不可救藥",
                idiomDescription: "藥：治療。病已重到無法用藥醫治的程度。比喻已經到了無法挽救的地步。",
                idiomImageName: "2026_day041"
            ),
            ...
            "02-11": LunarCalendarData(
                ...
                unsuitableActivities: "忌入宅、安葬",
                idiom: "入不敷出",
                idiomDescription: "敷：夠，足。收入不夠支出。",
                idiomImageName: "2026_day042"
            ),

            "02-12": LunarCalendarData(
                lunarTerm: "廿五",
                suitableActivities: "宜無",
                unsuitableActivities: "忌行喪、破土",
                idiom: "用愛發電",
                idiomDescription: "指無償為自己喜歡的事物作貢獻。",
                idiomImageName: "2026_day043"
            ),

            "02-13": LunarCalendarData(
                lunarTerm: "廿六",
                suitableActivities: "宜訂盟、出行",
                unsuitableActivities: "忌開光、蓋屋",
                idiom: "自掏腰包",
                idiomDescription: "由自己付錢。",
                idiomImageName: "2026_day044"
            ),
            ...
            "02-14": LunarCalendarData(
                ...
                unsuitableActivities: "忌開市、入宅",
                idiom: "若有若無",
                idiomDescription: "形容事物不清晰或關係不親密。",
                idiomImageName: "2026_day045"
            ),
            ...
            "02-16": LunarCalendarData(
                ...
                unsuitableActivities: "忌正四廢",
                idiom: "恭喜發財",
                idiomDescription: "恭喜：恭賀他人的喜事。舊時指祝賀人發財富裕的客套話。",
                idiomImageName: "2026_day047"
            ),
            ...
            "02-17": LunarCalendarData(
                ...
                unsuitableActivities: "忌受死",
                idiom: "一馬當先",
                idiomDescription: "原指作戰時策馬衝鋒在前。形容領先。也比喻工作走在群眾前麵，積極帶頭。",
                idiomImageName: "2026_day048"
            ),
            ...
            "02-19": LunarCalendarData(
                ...
                idiom: "飛鴿傳書",
                idiomDescription: "古代因缺少專門的郵差，所以只有利用飛鴿來幫人們傳遞消息。",
                idiomImageName: "2026_day050"
            ),

            "02-20": LunarCalendarData(
                lunarTerm: "初四",
                suitableActivities: "宜祭祀、祈福",
                unsuitableActivities: "忌栽種、開光",
                idiom: "馬爾濟斯",
                idiomDescription: "原產地為義大利，為白色長毛的小型犬種，血統上類近比熊犬、博洛尼亞犬及哈瓦那犬，性情溫和，外表可愛，撒嬌好客，因此十分受到人們的喜愛，是很受歡迎的犬種之一。",
                idiomImageName: "2026_day051"
            ),
            ...
            "02-21": LunarCalendarData(
                ...
                unsuitableActivities: "忌入宅、出行",
                idiom: "三十而立",
                idiomDescription: "指人在三十歲前後有所成就。",
                idiomImageName: "2026_day052"
            ),
            ...
            "02-22": LunarCalendarData(
                ...
                idiom: "湖光山色",
                idiomDescription: "形容湖的波光和山的景色，泛指美好的自然風光。",
                idiomImageName: "2026_day053"
            ),

            "02-23": LunarCalendarData(
                lunarTerm: "初七",
                suitableActivities: "宜會友、祈福",
                unsuitableActivities: "忌嫁娶、開市",
                idiom: "殺雞取卵",
                idiomDescription: "把雞殺了，取出腹中的蛋。比喻為貪圖眼前的好處而斷絕了長遠的利益。",
                idiomImageName: "2026_day054"
            ),
            ...
            "02-25": LunarCalendarData(
                ...
                unsuitableActivities: "忌經絡、探病",
                idiom: "車水馬龍",
                idiomDescription: "形容來往車馬很多，連續不斷的熱鬧情景。",
                idiomImageName: "2026_day056"
            ),
            ...
            "02-27": LunarCalendarData(
                ...
                idiom: "麵包超人",
                idiomDescription: "臉由紅豆麵包做成，是一位又剛強又善良的正義英雄。",
                idiomImageName: "2026_day058"
            ),

            "02-28": LunarCalendarData(
                lunarTerm: "十二",
                suitableActivities: "宜出行、移徙",
                unsuitableActivities: "忌安床、會友",
                idiom: "白色恐怖",
                idiomDescription: "你是忘記了，還是害怕想起來？",
                idiomImageName: "2026_day059"
            ),

            "03-01": LunarCalendarData(
                lunarTerm: "十三",
                suitableActivities: "宜結網、取漁",
                unsuitableActivities: "忌受死",
                idiom: "三月不知肉味",
                idiomDescription: "三個月之內吃肉不覺得有味道。比喻集中注意力於某一事物而忘記了其它事情。也借用來形容幾個月不吃肉。",
                idiomImageName: "2026_day060"
            ),

            "03-02": LunarCalendarData(
                lunarTerm: "十四",
                suitableActivities: "宜納采、祭祀",
                unsuitableActivities: "忌嫁娶、開市",
                idiom: "有機可乘",
                idiomDescription: "有機會可以利用，有空子可鑽。這個成語常帶有貶義，指存在可利用的機會或漏洞。",
                idiomImageName: "2026_day061"
            ),
            ...
            "03-03": LunarCalendarData(
                ...
                unsuitableActivities: "忌移徙、入宅",
                idiom: "呆若木雞",
                idiomDescription: "呆：傻，發愣的樣子。呆得象木頭雞一樣。形容因恐懼或驚異而發愣的樣子。",
                idiomImageName: "2026_day062"
            ),
            ...
            "03-04": LunarCalendarData(
                ...
                unsuitableActivities: "忌開光、蓋屋",
                idiom: "雞飛蛋打",
                idiomDescription: "雞飛走了，蛋打破了。比喻兩頭落空，一無所得。",
                idiomImageName: "2026_day063"
            ),

            "03-05": LunarCalendarData(
                lunarTerm: "驚蟄",
                suitableActivities: "宜訂盟、交易",
                unsuitableActivities: "忌祭祀、開光",
                idiom: "不堪負荷",
                idiomDescription: "無法承受、負擔。",
                idiomImageName: "2026_day064"
            ),

            "03-06": LunarCalendarData(
                lunarTerm: "十八",
                suitableActivities: "宜出行、嫁娶",
                unsuitableActivities: "忌掘井、動土",
                idiom: "守株待兔",
                idiomDescription: "指拘泥守成，不知變通，或妄想不勞而獲。",
                idiomImageName: "2026_day065"
            ),
            ...
            "03-07": LunarCalendarData(
                ...
                unsuitableActivities: "忌受死",
                idiom: "大吹法螺",
                idiomDescription: "比喻空口說大話。",
                idiomImageName: "2026_day066"
            ),

            "03-08": LunarCalendarData(
                lunarTerm: "廿十",
                suitableActivities: "宜開光、求嗣",
                unsuitableActivities: "忌出行、安葬",
                idiom: "澳大利亞",
                idiomDescription: "澳洲是一個廣闊多元的國家，以壯麗的自然景觀、獨特的野生動物和悠閒的生活方式聞名。它同時擁有現代城市與世界級海灘，是旅遊與生活的熱門地點。",
                idiomImageName: "2026_day067"
            ),

            "03-09": LunarCalendarData(
                lunarTerm: "廿一",
                suitableActivities: "宜祭祀、嫁娶",
                unsuitableActivities: "忌栽種、蓋屋",
                idiom: "好吃懶做",
                idiomDescription: "愛吃又懶得勞動。",
                idiomImageName: "2026_day068"
            ),

            "03-10": LunarCalendarData(
                lunarTerm: "廿二",
                suitableActivities: "宜入學、出行",
                unsuitableActivities: "忌伐木、作樑",
                idiom: "自掃門前雪",
                idiomDescription: "形容人只關心自己，不關心周圍的人或事。",
                idiomImageName: "2026_day069"
            ),

            "03-11": LunarCalendarData(
                lunarTerm: "廿三",
                suitableActivities: "宜入學、放水",
                unsuitableActivities: "忌入宅、安門",
                idiom: "沒齒難忘",
                idiomDescription: "指永遠難以忘記。",
                idiomImageName: "2026_day070"
            ),
            ...
            "03-12": LunarCalendarData(
                ...
                idiom: "歸心似箭",
                idiomDescription: "形容想回家的心情非常急切，就像射出的箭一樣快。",
                idiomImageName: "2026_day071"
            ),

            "03-13": LunarCalendarData(
                lunarTerm: "廿五",
                suitableActivities: "宜嫁娶、出行",
                unsuitableActivities: "忌開光、作灶",
                idiom: "小心慢行",
                idiomDescription: "用以警告車輛駕駛人前面路況變遷，應減速慢行。",
                idiomImageName: "2026_day072"
            ),

            "03-14": LunarCalendarData(
                lunarTerm: "廿六",
                suitableActivities: "宜開市、交易",
                unsuitableActivities: "忌理髮、伐木",
                idiom: "冷若冰霜",
                idiomDescription: "形容態度極為冷淡。",
                idiomImageName: "2026_day073"
            ),

            "03-15": LunarCalendarData(
                lunarTerm: "廿七",
                suitableActivities: "宜理髮、認養",
                unsuitableActivities: "忌置產、伐木",
                idiom: "阿里山茶",
                idiomDescription: "在台灣嘉義縣阿里山茶區所產的茶葉，以其獨特的清香、甘醇的滋味和豐富的香氣而聞名，是台灣頂級高山茶的代表之一。",
                idiomImageName: "2026_day074"
            ),

            "03-16": LunarCalendarData(
                lunarTerm: "廿八",
                suitableActivities: "宜出火、安床",
                unsuitableActivities: "忌合帳、開市",
                idiom: "情非得已",
                idiomDescription: "指在當時的情況下，不得不如此做。",
                idiomImageName: "2026_day075"
            ),
            ...
            "03-18": LunarCalendarData(
                ...
                unsuitableActivities: "忌祈福、動土",
                idiom: "豬突豨勇",
                idiomDescription: "豨：野豬。指拚命向前衝，不怕死的人（含貶義）。",
                idiomImageName: "2026_day077"
            ),

            "03-19": LunarCalendarData(
                lunarTerm: "二月",
                suitableActivities: "宜解除、捕捉",
                unsuitableActivities: "忌四離",
                idiom: "別樹一幟",
                idiomDescription: "另外打一旗號，喻另創格調，能夠獨立而自成一種局面。樹，立起。幟，旗幟。",
                idiomImageName: "2026_day078"
            ),

            "03-20": LunarCalendarData(
                lunarTerm: "春分",
                suitableActivities: "宜納財、修造",
                unsuitableActivities: "忌動土、出行",
                idiom: "玉樹臨風",
                idiomDescription: "形容人風度瀟灑，秀美多姿。",
                idiomImageName: "2026_day079"
            ),

            "03-21": LunarCalendarData(
                lunarTerm: "初三",
                suitableActivities: "宜祭祀、置產",
                unsuitableActivities: "忌開倉、出貨",
                idiom: "順手牽羊",
                idiomDescription: "趁機會就下手拿東西。喻偷竊的行為。",
                idiomImageName: "2026_day080"
            ),

            "03-22": LunarCalendarData(
                lunarTerm: "初四",
                suitableActivities: "宜出行、入宅",
                unsuitableActivities: "忌動土、伐木",
                idiom: "苟且偷生",
                idiomDescription: "得過且過，勉強地活下去，形容不顧一切只求暫時活命，缺乏長遠規劃和擔當。",
                idiomImageName: "2026_day081"
            ),
            ...
            "03-23": LunarCalendarData(
                ...
                unsuitableActivities: "忌開市、交易",
                idiom: "白日升天",
                idiomDescription: "原是道教指白晝升天成為神仙。後比喻一下子富貴起來。",
                idiomImageName: "2026_day082"
            ),
            ...
            "03-24": LunarCalendarData(
                ...
                unsuitableActivities: "忌月破",
                idiom: "救難解危",
                idiomDescription: "幫助陷入困境的人解除危難。",
                idiomImageName: "2026_day083"
            ),

            "03-25": LunarCalendarData(
                lunarTerm: "初七",
                suitableActivities: "宜納采、動土",
                unsuitableActivities: "忌嫁娶、開光",
                idiom: "非禮勿言",
                idiomDescription: "不符合禮儀規範的話，就不要說。",
                idiomImageName: "2026_day084"
            ),

            "03-26": LunarCalendarData(
                lunarTerm: "初八",
                suitableActivities: "宜祭祀、沐浴",
                unsuitableActivities: "忌合木、安葬",
                idiom: "機密文件",
                idiomDescription: "指的是重要且必須保密的公文、書信等。",
                idiomImageName: "2026_day085"
            ),

            "03-27": LunarCalendarData(
                lunarTerm: "初九",
                suitableActivities: "宜交易、栽種",
                unsuitableActivities: "忌入宅、蓋屋",
                idiom: "普天同慶",
                idiomDescription: "指全天下的人共同慶祝。",
                idiomImageName: "2026_day086"
            ),

            "03-28": LunarCalendarData(
                lunarTerm: "初十",
                suitableActivities: "宜出行、動土",
                unsuitableActivities: "忌開市、安葬",
                idiom: "三色糰子",
                idiomDescription: "是日本的一種傳統和菓子，通常由粉色、白色和綠色三種顏色的糰子組成。",
                idiomImageName: "2026_day087"
            ),
            ...
            "03-31": LunarCalendarData(
                ...
                idiom: "阿婆鐵蛋",
                idiomDescription: "因為過於忙碌無意間將蛋滷得太久，沒想到硬硬的滷蛋讓許多客人吃了之後都讚不絕口…",
                idiomImageName: "2026_day090"
            ),

            "04-01": LunarCalendarData(
                lunarTerm: "十四",
                suitableActivities: "宜納財、理髮",
                unsuitableActivities: "忌移徙、入宅",
                idiom: "大智若愚",
                idiomDescription: "表面上看起來很愚笨，實際上卻是大智大慧的人。",
                idiomImageName: "2026_day091"
            ),

            "04-02": LunarCalendarData(
                lunarTerm: "十五",
                suitableActivities: "宜會友、置產",
                unsuitableActivities: "忌開市、蓋屋",
                idiom: "四通八達",
                idiomDescription: "形容交通非常便利。",
                idiomImageName: "2026_day092"
            ),

            "04-03": LunarCalendarData(
                lunarTerm: "十六",
                suitableActivities: "宜嫁娶、訂盟",
                unsuitableActivities: "忌納畜、理髮",
                idiom: "花花世界",
                idiomDescription: "形容繁華熱鬧的景象，通常指都市或人世間的繁華熱鬧景象。",
                idiomImageName: "2026_day093"
            ),

            "04-04": LunarCalendarData(
                lunarTerm: "十七",
                suitableActivities: "宜出行、入宅",
                unsuitableActivities: "忌開光、安床",
                idiom: "兒童快樂",
                idiomDescription: "祝願孩子們在兒童節這天，都能開心、快樂地度過。",
                idiomImageName: "2026_day094"
            ),
            ...
            "04-06": LunarCalendarData(
                ...
                idiom: "無所事事",
                idiomDescription: "什麼事也不做，形容閒蕩無事的樣子。",
                idiomImageName: "2026_day096"
            ),

            "04-07": LunarCalendarData(
                lunarTerm: "廿十",
                suitableActivities: "宜塞穴、掃舍",
                unsuitableActivities: "忌受死",
                idiom: "睡前頌缽",
                idiomDescription: "每天睡前進行 10-15 分鐘的頌缽練習，能有效安撫心靈，為入睡做好準備。",
                idiomImageName: "2026_day097"
            ),

            "04-08": LunarCalendarData(
                lunarTerm: "廿一",
                suitableActivities: "宜開光、認養",
                unsuitableActivities: "忌開市、求財",
                idiom: "畫蛇添足",
                idiomDescription: "比喻多此一舉，反而把事情弄糟。",
                idiomImageName: "2026_day098"
            ),
            ...
            "04-10": LunarCalendarData(
                ...
                unsuitableActivities: "忌祭祀、安葬",
                idiom: "覆鹿尋蕉",
                idiomDescription: "覆：遮蓋；蕉：同“樵”，柴。比喻把真事看作夢幻而一再失誤。",
                idiomImageName: "2026_day100"
            ),

            "04-11": LunarCalendarData(
                lunarTerm: "廿四",
                suitableActivities: "宜安床、開池",
                unsuitableActivities: "忌嫁娶、探病",
                idiom: "沐猴而冠",
                idiomDescription: "沐猴：獼猴；冠：戴帽子。猴子穿衣戴帽，究竟不是真人。比喻虛有其表，形同傀儡。常用來諷刺投靠惡勢力竊據權位的人。",
                idiomImageName: "2026_day101"
            ),

            "04-12": LunarCalendarData(
                lunarTerm: "廿五",
                suitableActivities: "宜出行、掃舍",
                unsuitableActivities: "忌開光、伐木",
                idiom: "錦上添花",
                idiomDescription: "比喻美上加美，在已經美好的事物上再加以讚美。",
                idiomImageName: "2026_day102"
            ),

            "04-13": LunarCalendarData(
                lunarTerm: "廿六",
                suitableActivities: "宜祭祀、祈福",
                unsuitableActivities: "忌修墳、出行",
                idiom: "非禮勿視",
                idiomDescription: "不合乎禮的要求，就不要去看。",
                idiomImageName: "2026_day103"
            ),
            ...
            "04-19": LunarCalendarData(
                ...
                idiom: "回頭是岸",
                idiomDescription: "比喻做錯事的人，只要真心悔改，就有出路。",
                idiomImageName: "2026_day109"
            ),

            "04-20": LunarCalendarData(
                lunarTerm: "穀雨",
                suitableActivities: "宜開市、祈福",
                unsuitableActivities: "忌訂盟、破土",
                idiom: "天外奇蹟",
                idiomDescription: "是一部2009年的皮克斯動畫電影，講述卡爾老爺爺和童子軍小羅，兩人一場驚險又感人的冒險故事。",
                idiomImageName: "2026_day110"
            ),
            ...
            "04-21": LunarCalendarData(
                ...
                idiom: "粒粒皆辛苦",
                idiomDescription: "每一粒米飯都是農民辛苦勞動的成果，勸誡人們要珍惜糧食，不要浪費。",
                idiomImageName: "2026_day111"
            ),

            "04-22": LunarCalendarData(
                lunarTerm: "初六",
                suitableActivities: "宜出行、置產",
                unsuitableActivities: "忌作灶、安葬",
                idiom: "不速之客",
                idiomDescription: "不經邀請，自己出現的客人。",
                idiomImageName: "2026_day112"
            ),
            ...
            "04-24": LunarCalendarData(
                ...
                idiom: "飽讀詩書",
                idiomDescription: "讀過很多書，很有學問。",
                idiomImageName: "2026_day114"
            ),

            "04-25": LunarCalendarData(
                lunarTerm: "初九",
                suitableActivities: "宜嫁娶、出火",
                unsuitableActivities: "忌出行、開市",
                idiom: "鞠躬盡瘁",
                idiomDescription: "不辭勞苦，不懼艱鉅，對於國事盡忠盡力，毫不懈怠。",
                idiomImageName: "2026_day115"
            ),

            "04-26": LunarCalendarData(
                lunarTerm: "初十",
                suitableActivities: "宜出行、會友",
                unsuitableActivities: "忌祈福、探病",
                idiom: "如履薄冰",
                idiomDescription: "比喻行事非常謹慎小心，生怕稍有不慎就會發生危險。",
                idiomImageName: "2026_day116"
            ),
            ...
            "04-27": LunarCalendarData(
                ...
                idiom: "皮卡皮卡",
                idiomDescription: "皮卡丘是一種電屬性寶可夢，外形像一隻小老鼠，有著黃色的毛皮、紅色的臉頰、棕色的背紋和一條閃電狀的尾巴。",
                idiomImageName: "2026_day117"
            ),

            "04-28": LunarCalendarData(
                lunarTerm: "十二",
                suitableActivities: "宜求嗣、破土",
                unsuitableActivities: "忌入宅、嫁娶",
                idiom: "盲人摸象",
                idiomDescription: "比喻對事物只憑片面的認識，就妄下判斷，以致以偏概全，無法了解事情的全貌。",
                idiomImageName: "2026_day118"
            ),

            "04-29": LunarCalendarData(
                lunarTerm: "十三",
                suitableActivities: "宜出行、蓋屋",
                unsuitableActivities: "忌嫁娶、納財",
                idiom: "貓空纜車",
                idiomDescription: "位於臺北市文山區的一條觀光纜車，全長4.03公里，於2007年7月4日啟用，由臺北捷運公司營運。",
                idiomImageName: "2026_day119"
            ),

            "04-30": LunarCalendarData(
                lunarTerm: "十四",
                suitableActivities: "宜沐浴、求醫",
                unsuitableActivities: "忌月破",
                idiom: "求神拜佛",
                idiomDescription: "向神佛祈禱保祐。",
                idiomImageName: "2026_day120"
            ),
            ...
            "05-01": LunarCalendarData(
                ...
                idiom: "為五斗米折腰",
                idiomDescription: "願為微薄的俸祿而卑躬屈膝、諂媚奉承。",
                idiomImageName: "2026_day121"
            ),

            "05-02": LunarCalendarData(
                lunarTerm: "十六",
                suitableActivities: "宜祭祀、出貨",
                unsuitableActivities: "忌出火、嫁娶",
                idiom: "黃金烏龍拿鐵",
                idiomDescription: "它結合了烏龍茶的茶香和奶香，口感順滑。",
                idiomImageName: "2026_day122"
            ),
            ...
            "05-04": LunarCalendarData(
                ...
                idiom: "大雨滂沱",
                idiomDescription: "形容雨勢盛大。《三國演義》第二八回：「行了數日，忽值大雨滂沱，行裝盡溼。」",
                idiomImageName: "2026_day124"
            ),

            "05-05": LunarCalendarData(
                lunarTerm: "立夏",
                suitableActivities: "宜開光、出行",
                unsuitableActivities: "忌入宅、探病",
                idiom: "虎虎生風",
                idiomDescription: "形容雄壯威武，氣勢非凡。",
                idiomImageName: "2026_day125"
            ),
            ...
            "05-07": LunarCalendarData(
                ...
                idiom: "當心動物",
                idiomDescription: "用以促使車輛駕駛人注意慢行。",
                idiomImageName: "2026_day127"
            ),

            "05-08": LunarCalendarData(
                lunarTerm: "廿一",
                suitableActivities: "宜開市、交易",
                unsuitableActivities: "忌安床、探病",
                idiom: "小心火燭",
                idiomDescription: "提醒大家要注意用火安全，防止發生火災。",
                idiomImageName: "2026_day128"
            ),

            "05-09": LunarCalendarData(
                lunarTerm: "廿二",
                suitableActivities: "宜認養、會友",
                unsuitableActivities: "忌塞穴、上樑",
                idiom: "飲鴆止渴",
                idiomDescription: "比喻只求解決眼前困難，而不顧將來更大的禍患。",
                idiomImageName: "2026_day129"
            ),

            "05-10": LunarCalendarData(
                lunarTerm: "廿三",
                suitableActivities: "宜沐浴、破土",
                unsuitableActivities: "忌嫁娶、伐木",
                idiom: "狐朋狗友",
                idiomDescription: "比喻相互勾結，為非作惡的人。",
                idiomImageName: "2026_day130"
            ),
            ...
            "05-11": LunarCalendarData(
                ...
                idiom: "風流可愛",
                idiomDescription: "形容人具有一種瀟灑、不拘小節，又帶有魅力和討人喜歡的氣質。",
                idiomImageName: "2026_day131"
            ),

            "05-12": LunarCalendarData(
                lunarTerm: "廿五",
                suitableActivities: "宜祈福、放水",
                unsuitableActivities: "忌出行、求醫",
                idiom: "偷天換日",
                idiomDescription: "比喻騙局之大與技巧之妙。",
                idiomImageName: "2026_day132"
            ),
            ...
            "05-13": LunarCalendarData(
                ...
                idiom: "任勞任怨",
                idiomDescription: "形容人做事熱心負責，不辭勞苦，不怕嫌怨。",
                idiomImageName: "2026_day133"
            ),

            "05-14": LunarCalendarData(
                lunarTerm: "廿七",
                suitableActivities: "宜訂盟、動土",
                unsuitableActivities: "忌開市、立券",
                idiom: "靈光一閃",
                idiomDescription: "靈機一動，突發的想法。",
                idiomImageName: "2026_day134"
            ),
            ...
            "05-15": LunarCalendarData(
                ...
                idiom: "冰山一角",
                idiomDescription: "比喻顯露出來的只是事物的一小部分，還有更多隱藏著。",
                idiomImageName: "2026_day135"
            ),

            "05-16": LunarCalendarData(
                lunarTerm: "廿九",
                suitableActivities: "宜解除、出行",
                unsuitableActivities: "忌伐木、安床",
                idiom: "貓有九命",
                idiomDescription: "“A cat has nine lives”，形容貓咪生命力頑強、總能化險為夷。",
                idiomImageName: "2026_day136"
            ),
            ...
            "05-17": LunarCalendarData(
                ...
                idiom: "三色豆子",
                idiomDescription: "是由玉米粒（黃色）、胡蘿蔔丁（橘色）、豌豆仁（綠色）構成的蔬菜組合，常以冷凍蔬菜的形式出現。",
                idiomImageName: "2026_day137"
            ),

            "05-18": LunarCalendarData(
                lunarTerm: "初二",
                suitableActivities: "宜嫁娶、開廁",
                unsuitableActivities: "忌安床、開渠",
                idiom: "招蜂引蝶",
                idiomDescription: "形容一個人因為外表漂亮、舉止吸引人，從而吸引了許多異性前來追求或關注。",
                idiomImageName: "2026_day138"
            ),

            "05-19": LunarCalendarData(
                lunarTerm: "初三",
                suitableActivities: "宜斷蟻、結網",
                unsuitableActivities: "忌受死",
                idiom: "無精打采",
                idiomDescription: "指一個人缺乏精神和活力，顯得懶散、提不起勁，對周圍的事物沒有興趣或熱情。",
                idiomImageName: "2026_day139"
            ),

            "05-20": LunarCalendarData(
                lunarTerm: "初四",
                suitableActivities: "宜出行、入宅",
                unsuitableActivities: "忌作灶、安床",
                idiom: "長風破浪",
                idiomDescription: "比喻排除萬難，奮勇前進。",
                idiomImageName: "2026_day140"
            ),
            ...
            "05-21": LunarCalendarData(
                ...
                idiom: "越俎代庖",
                idiomDescription: "比喻踰越職分，代他人做事。",
                idiomImageName: "2026_day141"
            ),

            "05-22": LunarCalendarData(
                lunarTerm: "初六",
                suitableActivities: "宜理髮、出行",
                unsuitableActivities: "忌伐木、安葬",
                idiom: "孔融讓梨",
                idiomDescription: "比喻懂得謙讓、禮讓他人，尤其是年幼者尊敬年長者。",
                idiomImageName: "2026_day142"
            ),

            "05-23": LunarCalendarData(
                lunarTerm: "初七",
                suitableActivities: "宜出行、蓋屋",
                unsuitableActivities: "忌作灶、嫁娶",
                idiom: "非禮勿聽",
                idiomDescription: "不符合禮制的事情不要聽。",
                idiomImageName: "2026_day143"
            ),

            "05-24": LunarCalendarData(
                lunarTerm: "初八",
                suitableActivities: "宜認養、入宅",
                unsuitableActivities: "忌開市、立券",
                idiom: "風馳電掣",
                idiomDescription: "形容速度極快，像風一樣奔跑，像閃電一樣快速掠過，出自《六韜·龍韜·王翼》。",
                idiomImageName: "2026_day144"
            ),
            ...
            "05-25": LunarCalendarData(
                ...
                idiom: "振筆疾書",
                idiomDescription: "形容文思泉湧，飛快地寫字。",
                idiomImageName: "2026_day145"
            ),

            "05-26": LunarCalendarData(
                lunarTerm: "初十",
                suitableActivities: "宜出行、出火",
                unsuitableActivities: "忌作灶、開市",
                idiom: "木已成舟",
                idiomDescription: "木頭已經做成了船。比喻事情已成定局，沒有辦法再挽回或是不可能再改變了。",
                idiomImageName: "2026_day146"
            ),
            ...
            "05-31": LunarCalendarData(
                ...
                idiom: "種瓜得瓜",
                idiomDescription: "比喻種什麼因就得什麼果。",
                idiomImageName: "2026_day151"
            ),

            "06-01": LunarCalendarData(
                lunarTerm: "十六",
                suitableActivities: "宜嫁娶、入宅",
                unsuitableActivities: "忌開市、出行",
                idiom: "接二連三",
                idiomDescription: "形容事情一個接著一個地發生，沒有間斷。",
                idiomImageName: "2026_day152"
            ),

            "06-02": LunarCalendarData(
                lunarTerm: "十七",
                suitableActivities: "宜會友、結網",
                unsuitableActivities: "忌開市、作灶",
                idiom: "三陽開泰",
                idiomDescription: "新春頌詞，表示正月新春，萬象更新。",
                idiomImageName: "2026_day153"
            ),
            ...
            "06-03": LunarCalendarData(
                ...
                idiom: "虎背熊腰",
                idiomDescription: "形容人的體格健壯，體型魁武，背部和腰部都很寬厚有力。",
                idiomImageName: "2026_day154"
            ),

            "06-04": LunarCalendarData(
                lunarTerm: "十九",
                suitableActivities: "宜祭祀、安門",
                unsuitableActivities: "忌動土、破土",
                idiom: "十惡不赦",
                idiomDescription: "形容罪大惡極，不可饒恕。",
                idiomImageName: "2026_day155"
            ),

            "06-05": LunarCalendarData(
                lunarTerm: "芒種",
                suitableActivities: "宜開光、求醫",
                unsuitableActivities: "忌入宅、蓋屋",
                idiom: "鱷魚眼淚",
                idiomDescription: "形容那些虛偽、假裝悲傷的人。",
                idiomImageName: "2026_day156"
            ),
            ...
            "06-07": LunarCalendarData(
                ...
                idiom: "光陰似箭",
                idiomDescription: "形容時間消逝如飛箭般迅速。",
                idiomImageName: "2026_day158"
            ),

            "06-08": LunarCalendarData(
                lunarTerm: "廿三",
                suitableActivities: "宜開市、動土",
                unsuitableActivities: "忌安門、栽種",
                idiom: "蝸角之爭",
                idiomDescription: "比喻因細小的緣故而引起的爭端。",
                idiomImageName: "2026_day159"
            ),

            "06-09": LunarCalendarData(
                lunarTerm: "廿四",
                suitableActivities: "宜納財、動土",
                unsuitableActivities: "忌嫁娶、出火",
                idiom: "環遊世界",
                idiomDescription: "指透過旅行的方式，走遍地球上的各個角落，完成一趟繞地球一周的旅程。",
                idiomImageName: "2026_day160"
            ),
            ...
            "06-13": LunarCalendarData(
                ...
                idiom: "東京鐵塔",
                idiomDescription: "建於1958年。 高332.9公尺，是日本第二高的結構物，僅次於東京晴空塔。",
                idiomImageName: "2026_day164"
            ),

            "06-14": LunarCalendarData(
                lunarTerm: "廿九",
                suitableActivities: "宜開市、出行",
                unsuitableActivities: "忌安葬、破土",
                idiom: "掩耳盜鈴",
                idiomDescription: "比喻妄想瞞騙他人，結果卻只是欺騙自己而已。",
                idiomImageName: "2026_day165"
            ),

            "06-15": LunarCalendarData(
                lunarTerm: "五月",
                suitableActivities: "宜出行、入宅",
                unsuitableActivities: "忌納采、訂盟",
                idiom: "畫龍點睛",
                idiomDescription: "比喻繪畫、作文時在最重要之處加上一筆，使全體更加生動傳神。",
                idiomImageName: "2026_day166"
            ),

            "06-16": LunarCalendarData(
                lunarTerm: "初二",
                suitableActivities: "宜嫁娶、理髮",
                unsuitableActivities: "忌破土、出行",
                idiom: "愚公移山",
                idiomDescription: "比喻努力不懈，終能達成目標。或比喻效率不佳。",
                idiomImageName: "2026_day167"
            ),
            ...
            "06-17": LunarCalendarData(
                ...
                idiom: "步步為營",
                idiomDescription: "形容小心謹慎，防備周全的態度或做法。",
                idiomImageName: "2026_day168"
            ),

            "06-18": LunarCalendarData(
                lunarTerm: "初四",
                suitableActivities: "宜捕捉、結網",
                unsuitableActivities: "忌正四廢",
                idiom: "查理布朗",
                idiomDescription: "在《花生漫畫》中以其善良、溫和、但經常遭遇挫折的性格而聞名。 儘管他經常失敗，但仍充滿希望和決心。",
                idiomImageName: "2026_day169"
            ),
            ...
            "06-20": LunarCalendarData(
                ...
                idiom: "勢在必行",
                idiomDescription: "迫於情勢，非做不可。",
                idiomImageName: "2026_day171"
            ),

            "06-21": LunarCalendarData(
                lunarTerm: "夏至",
                suitableActivities: "宜開市、交易",
                unsuitableActivities: "忌出火、祭祀",
                idiom: "抹茶芒果",
                idiomDescription: "抹茶的草味與芒果的清新味道完美融合，夏至不可錯過的美食。",
                idiomImageName: "2026_day172"
            ),
            ...
            "06-22": LunarCalendarData(
                ...
                idiom: "鬼鬼祟祟",
                idiomDescription: "形容行事不光明，偷偷摸摸的樣子。",
                idiomImageName: "2026_day173"
            ),

            "06-23": LunarCalendarData(
                lunarTerm: "初九",
                suitableActivities: "宜嫁娶、出行",
                unsuitableActivities: "忌置產、入宅",
                idiom: "一事無成",
                idiomDescription: "一件事也沒做成。指事業毫無成就。語出唐·白居易《除夜寄微之》詩。",
                idiomImageName: "2026_day174"
            ),

            "06-24": LunarCalendarData(
                lunarTerm: "初十",
                suitableActivities: "宜修造、動土",
                unsuitableActivities: "忌安床、出行",
                idiom: "不堪一擊",
                idiomDescription: "比喻脆弱，禁不起任何的攻擊或打擊。",
                idiomImageName: "2026_day175"
            ),

            "06-25": LunarCalendarData(
                lunarTerm: "十一",
                suitableActivities: "宜出行、馴畜",
                unsuitableActivities: "忌蓋屋、動土",
                idiom: "大手一揮",
                idiomDescription: "形容一個人揮霍無度，揮一揮手就把金錢揮出去，散盡家財。",
                idiomImageName: "2026_day176"
            ),
            ...
            "06-29": LunarCalendarData(
                ...
                idiom: "心如止水",
                idiomDescription: "心志不為外物所動，如靜止不流動的水。",
                idiomImageName: "2026_day180"
            ),

            "06-30": LunarCalendarData(
                lunarTerm: "十六",
                suitableActivities: "宜出行、修造",
                unsuitableActivities: "忌嫁娶、開市",
                idiom: "大藝術家",
                idiomDescription: "指在藝術領域具有卓越成就或影響力的人。",
                idiomImageName: "2026_day181"
            ),
            ...
            "07-01": LunarCalendarData(
                ...
                idiom: "七步成詩",
                idiomDescription: "形容有才氣，文思敏捷。",
                idiomImageName: "2026_day182"
            ),

            "07-02": LunarCalendarData(
                lunarTerm: "十八",
                suitableActivities: "宜出行、祈福",
                unsuitableActivities: "忌理髮、安葬",
                idiom: "坐立難安",
                idiomDescription: "指是一個人情緒不安，坐也不是，站也不是。",
                idiomImageName: "2026_day183"
            ),

            "07-03": LunarCalendarData(
                lunarTerm: "十九",
                suitableActivities: "宜求醫、開市",
                unsuitableActivities: "忌祭祀、入宅",
                idiom: "信誓旦旦",
                idiomDescription: "比喻說話或發誓時態度誠懇、可靠。",
                idiomImageName: "2026_day184"
            ),
            ...
            "07-04": LunarCalendarData(
                ...
                idiom: "一刻千金",
                idiomDescription: "意謂極短暫的時間，卻有著千金的價值，也就表示時間是極為寶貴，教人珍惜的。",
                idiomImageName: "2026_day185"
            ),

            "07-05": LunarCalendarData(
                lunarTerm: "廿一",
                suitableActivities: "宜會友、動土",
                unsuitableActivities: "忌上樑、經絡",
                idiom: "野外求生",
                idiomDescription: "指在沒有人類居住的自然環境中，運用自然常識和可利用的資源來維持生存。",
                idiomImageName: "2026_day186"
            ),
            ...
            "07-08": LunarCalendarData(
                ...
                idiom: "危機四伏",
                idiomDescription: "任何地方都可能存在著危險，需要特別小心謹慎。",
                idiomImageName: "2026_day189"
            ),

            "07-09": LunarCalendarData(
                lunarTerm: "廿五",
                suitableActivities: "宜祈福、認養",
                unsuitableActivities: "忌安機、造車",
                idiom: "化為泡影",
                idiomDescription: "變成很快就消失的泡沫和幻影。比喻希望破滅。",
                idiomImageName: "2026_day190"
            ),

            "07-10": LunarCalendarData(
                lunarTerm: "廿六",
                suitableActivities: "宜解除、理髮",
                unsuitableActivities: "忌作灶、動土",
                idiom: "如影隨形",
                idiomDescription: "比喻兩個人或兩件事物關係密切，無法分離。",
                idiomImageName: "2026_day191"
            ),

            "07-11": LunarCalendarData(
                lunarTerm: "廿七",
                suitableActivities: "宜祭祀、解除",
                unsuitableActivities: "忌伐木、破土",
                idiom: "若即若離",
                idiomDescription: "形容對人保持一定距離，彼此關係不密切。",
                idiomImageName: "2026_day192"
            ),

            "07-12": LunarCalendarData(
                lunarTerm: "廿八",
                suitableActivities: "宜祭祀、安床",
                unsuitableActivities: "忌嫁娶、栽種",
                idiom: "雨過天晴",
                idiomDescription: "喻經過黑暗或動亂之後轉為光明平靜。",
                idiomImageName: "2026_day193"
            ),
            ...
            "07-14": LunarCalendarData(
                ...
                idiom: "虎視鷹瞵",
                idiomDescription: "如猛虎、老鷹般凶狠的注視。比喻強敵環繞、窺視。",
                idiomImageName: "2026_day195"
            ),

            "07-15": LunarCalendarData(
                lunarTerm: "初二",
                suitableActivities: "宜開市、入學",
                unsuitableActivities: "忌入宅、移徙",
                idiom: "焦頭爛額",
                idiomDescription: "形容非常狼狽窘迫，或事情繁瑣忙碌，不知如何是好的樣子。",
                idiomImageName: "2026_day196"
            ),
            ...
            "07-16": LunarCalendarData(
                ...
                idiom: "願者上鉤",
                idiomDescription: "指心甘情願地接受或從事某種行為，即使可能因此而遭受損失或不利。",
                idiomImageName: "2026_day197"
            ),

            "07-17": LunarCalendarData(
                lunarTerm: "初四",
                suitableActivities: "宜納財、結網",
                unsuitableActivities: "忌開渠、安床",
                idiom: "垃圾食物",
                idiomDescription: "高油、高鹽、高糖的食物，食用有益身心健康。",
                idiomImageName: "2026_day198"
            ),

            "07-18": LunarCalendarData(
                lunarTerm: "初五",
                suitableActivities: "宜蓋屋、修造",
                unsuitableActivities: "忌栽種、出行",
                idiom: "萬箭穿心",
                idiomDescription: "它形容內心極度痛苦，就像被萬支箭穿透心臟一樣。",
                idiomImageName: "2026_day199"
            ),
            ...
            "07-19": LunarCalendarData(
                ...
                idiom: "心狠手辣",
                idiomDescription: "居心狠毒，手段殘酷。",
                idiomImageName: "2026_day200"
            ),

            "07-20": LunarCalendarData(
                lunarTerm: "初七",
                suitableActivities: "宜嫁娶、出行",
                unsuitableActivities: "忌入宅、栽種",
                idiom: "對牛彈琴",
                idiomDescription: "指對不懂道理的人講道理，或是不看對象的講話，比喻雙方無法溝通。",
                idiomImageName: "2026_day201"
            ),
            ...
            "07-21": LunarCalendarData(
                ...
                idiom: "消磨殆盡",
                idiomDescription: "指事物逐漸減少直至完全消失，不復存在。",
                idiomImageName: "2026_day202"
            ),

            "07-22": LunarCalendarData(
                lunarTerm: "初九",
                suitableActivities: "宜嫁娶、出行",
                unsuitableActivities: "忌上樑、入宅",
                idiom: "光芒萬丈",
                idiomDescription: "光輝燦爛，照耀遠方。比喻氣勢雄厚。",
                idiomImageName: "2026_day203"
            ),
            ...
            "07-23": LunarCalendarData(
                ...
                idiom: "文思泉湧",
                idiomDescription: "喻行文時思路的迅速豐暢。",
                idiomImageName: "2026_day204"
            ),

            "07-24": LunarCalendarData(
                lunarTerm: "十一",
                suitableActivities: "宜入學、會友",
                unsuitableActivities: "忌嫁娶、置產",
                idiom: "飽餐一頓",
                idiomDescription: "痛快地、盡情地吃了一頓飯。",
                idiomImageName: "2026_day205"
            ),
            ...
            "07-27": LunarCalendarData(
                ...
                idiom: "好事花生",
                idiomDescription: "好事會發生，用來表達祝福，寓意著好運、吉祥和喜事。",
                idiomImageName: "2026_day208"
            ),

            "07-28": LunarCalendarData(
                lunarTerm: "十五",
                suitableActivities: "宜蓋屋、會友",
                unsuitableActivities: "忌入宅、開市",
                idiom: "披星戴月",
                idiomDescription: "在星光與月光下奔波，形容辛勤勞動或旅途辛苦。",
                idiomImageName: "2026_day209"
            ),

            "07-29": LunarCalendarData(
                lunarTerm: "十六",
                suitableActivities: "宜納采、出行",
                unsuitableActivities: "忌安葬、出貨",
                idiom: "鑽木取火",
                idiomDescription: "上古時代以尖石鑽木，藉磨擦生熱以點燃木材生火的方法。",
                idiomImageName: "2026_day210"
            ),

            "07-30": LunarCalendarData(
                lunarTerm: "十七",
                suitableActivities: "宜沐浴、伐木",
                unsuitableActivities: "忌出行、安葬",
                idiom: "開懷暢飲",
                idiomDescription: "心情無拘無束，盡情地飲酒作樂。",
                idiomImageName: "2026_day211"
            ),
            ...
            "08-01": LunarCalendarData(
                ...
                unsuitableActivities: "忌動土、破土",
                idiom: "遊刃有餘",
                idiomDescription: "比喻做事能勝任愉快，從容不迫。語本《莊子．養生主》。",
                idiomImageName: "2026_day213"
            ),

            "08-02": LunarCalendarData(
                lunarTerm: "廿十",
                suitableActivities: "宜沐浴、入學",
                unsuitableActivities: "忌嫁娶、出行",
                idiom: "訛言謊語",
                idiomDescription: "說謊、說假話，指捏造事實，欺騙他人。",
                idiomImageName: "2026_day214"
            ),
            ...
            "08-04": LunarCalendarData(
                ...
                idiom: "指鹿為馬",
                idiomDescription: "比喻故意顛倒是非，混淆黑白，也泛指不顧事實，硬說假話。",
                idiomImageName: "2026_day216"
            ),

            "08-05": LunarCalendarData(
                lunarTerm: "廿三",
                suitableActivities: "宜訂盟、入宅",
                unsuitableActivities: "忌安葬、破土",
                idiom: "煮豆燃萁",
                idiomDescription: "比喻親人、同族或同伴之間互相爭鬥、傷害，令人感到悲哀和無奈。",
                idiomImageName: "2026_day217"
            ),
            ...
            "08-10": LunarCalendarData(
                ...
                idiom: "風雨無阻",
                idiomDescription: "比喻做事堅定不移，不受任何阻礙或干擾。",
                idiomImageName: "2026_day222"
            ),

            "08-11": LunarCalendarData(
                lunarTerm: "廿九",
                suitableActivities: "宜開光、解除",
                unsuitableActivities: "忌動土、理髮",
                idiom: "亡羊補牢",
                idiomDescription: "喻出了問題以後，想辦法補救，免得再受損失。",
                idiomImageName: "2026_day223"
            ),
            ...
            "08-12": LunarCalendarData(
                ...
                idiom: "魚躍龍門",
                idiomDescription: "比喻逆流而上，奮發向上，不畏艱難的精神。",
                idiomImageName: "2026_day224"
            ),

            "08-13": LunarCalendarData(
                lunarTerm: "七月",
                suitableActivities: "宜祭祀、動土",
                unsuitableActivities: "忌出行、修造",
                idiom: "鬼門開",
                idiomDescription: "在台灣民間習俗中，這一天鬼門會打開，讓陰間的鬼魂回到陽間。人們會進行中元普渡等祭祀活動，祭拜好兄弟，祈求平安。",
                idiomImageName: "2026_day225"
            ),

            "08-14": LunarCalendarData(
                lunarTerm: "初二",
                suitableActivities: "宜安門、出行",
                unsuitableActivities: "忌安床、動土",
                idiom: "怒氣沖沖",
                idiomDescription: "形容一個人情緒激動，充滿怒火。",
                idiomImageName: "2026_day226"
            ),
            ...
            "08-15": LunarCalendarData(
                ...
                idiom: "一日千里",
                idiomDescription: "形容馬跑得很快，後也用來比喻進步神速或事業發展得很快。",
                idiomImageName: "2026_day227"
            ),

            "08-16": LunarCalendarData(
                lunarTerm: "初四",
                suitableActivities: "宜納采、出行",
                unsuitableActivities: "忌伐木、謝土",
                idiom: "花好月圓",
                idiomDescription: "比喻人事圓滿順利或美好的景象，常用於新婚祝賀的場合。",
                idiomImageName: "2026_day228"
            ),
            ...
            "08-18": LunarCalendarData(
                ...
                idiom: "臨陣脫逃",
                idiomDescription: "指軍人臨到上陣作戰時卻逃跑了。 也比喻臨場退卻，在關鍵時刻退縮、逃避。",
                idiomImageName: "2026_day230"
            ),

            "08-19": LunarCalendarData(
                lunarTerm: "初七",
                suitableActivities: "宜捕捉、除服",
                unsuitableActivities: "忌受死",
                idiom: "愛莫能助",
                idiomDescription: "指內心雖然同情，想要幫助卻無能為力。",
                idiomImageName: "2026_day231"
            ),
            ...
            "08-20": LunarCalendarData(
                ...
                idiom: "無能為力",
                idiomDescription: "毫無辦法。語出左傳隱公四年：「衞國褊小，老夫耄矣，無能為也。」。",
                idiomImageName: "2026_day232"
            ),

            "08-21": LunarCalendarData(
                lunarTerm: "初九",
                suitableActivities: "宜祈福、出行",
                unsuitableActivities: "忌理髮、動土",
                idiom: "小熊維尼",
                idiomDescription: "主要食糧是蜂蜜，而當蜂蜜吃完以後常常立刻跑去瑞比家要蜂蜜；雖然常常因為腦袋小而提供錯誤解決辦法，不過對朋友很講義氣。",
                idiomImageName: "2026_day233"
            ),

            "08-22": LunarCalendarData(
                lunarTerm: "初十",
                suitableActivities: "宜安機、出行",
                unsuitableActivities: "忌入宅、嫁娶",
                idiom: "孔雀開屏",
                idiomDescription: "雄性孔雀，尾有長羽，能張開成扇狀，有翠綠斑紋，非常美麗，藉以吸引異性。",
                idiomImageName: "2026_day234"
            ),
            ...
            "08-23": LunarCalendarData(
                ...
                idiom: "目不轉睛",
                idiomDescription: "形容聚精會神注視著，連眼珠也不轉動一下。",
                idiomImageName: "2026_day235"
            ),

            "08-24": LunarCalendarData(
                lunarTerm: "十二",
                suitableActivities: "宜出行、理髮",
                unsuitableActivities: "忌入宅、蓋屋",
                idiom: "酒肉朋友",
                idiomDescription: "那些只在有吃喝玩樂時才會出現，而無法在困境中互相扶持的朋友。",
                idiomImageName: "2026_day236"
            ),
            ...
            "08-29": LunarCalendarData(
                ...
                idiom: "遍體鱗傷",
                idiomDescription: "形容身體受外力摧殘得很厲害。",
                idiomImageName: "2026_day241"
            ),

            "08-30": LunarCalendarData(
                lunarTerm: "十八",
                suitableActivities: "宜動土、出行",
                unsuitableActivities: "忌開市、立券",
                idiom: "苟延殘喘",
                idiomDescription: "比喻勉強維持生命或撐住場面，也指勉強維持生存。",
                idiomImageName: "2026_day242"
            ),

            "08-31": LunarCalendarData(
                lunarTerm: "十九",
                suitableActivities: "宜祭祀、普渡",
                unsuitableActivities: "忌受死",
                idiom: "法國長棍",
                idiomDescription: "是一種經典的法式麵包，以其細長的外形、酥脆的外皮和柔軟蓬鬆的內部聞名。",
                idiomImageName: "2026_day243"
            ),
            ...
            "09-01": LunarCalendarData(
                ...
                idiom: "鵬程萬里",
                idiomDescription: "大鵬飛行的路程數萬里。比喻前程遠大，不可限量。",
                idiomImageName: "2026_day244"
            ),

            "09-02": LunarCalendarData(
                lunarTerm: "廿一",
                suitableActivities: "宜祈福、入宅",
                unsuitableActivities: "忌動土、破土",
                idiom: "岌岌可危",
                idiomDescription: "形容十分危險，將要傾覆或滅亡。",
                idiomImageName: "2026_day245"
            ),

            "09-03": LunarCalendarData(
                lunarTerm: "廿二",
                suitableActivities: "宜嫁娶、祈福",
                unsuitableActivities: "忌訂盟、探病",
                idiom: "哆啦A夢",
                idiomDescription: "來自未來世界二十二世紀的機器人，為避免大雄的命運走向悲慘而來。害怕老鼠，喜歡吃銅鑼燒。",
                idiomImageName: "2026_day246"
            ),

            "09-04": LunarCalendarData(
                lunarTerm: "廿三",
                suitableActivities: "宜嫁娶、作灶",
                unsuitableActivities: "忌出行、破土",
                idiom: "魂飛天外",
                idiomDescription: "形容萬分恐懼，或受到某種刺激而失去了主宰。",
                idiomImageName: "2026_day247"
            ),

            "09-05": LunarCalendarData(
                lunarTerm: "廿四",
                suitableActivities: "宜會友、普渡",
                unsuitableActivities: "忌出火、入宅",
                idiom: "壽終正寢",
                idiomDescription: "比喻事物自然消亡，例如一個計畫、政策或制度的終結。",
                idiomImageName: "2026_day248"
            ),
            ...
            "09-06": LunarCalendarData(
                ...
                idiom: "極樂世界",
                idiomDescription: "是一個永遠的歸宿，一個沒有痛苦，只有快樂的理想國度，是佛教徒嚮往的修行境界。",
                idiomImageName: "2026_day249"
            ),

            "09-07": LunarCalendarData(
                lunarTerm: "白露",
                suitableActivities: "宜出行、伐木",
                unsuitableActivities: "忌掘井、祈福",
                idiom: "病入膏肓",
                idiomDescription: "指病情嚴重到無法救治的地步，也用來比喻事情已到無法挽回的程度。",
                idiomImageName: "2026_day250"
            ),

            "09-08": LunarCalendarData(
                lunarTerm: "廿七",
                suitableActivities: "宜祭祀、掃舍",
                unsuitableActivities: "忌分居、出行",
                idiom: "不可置信",
                idiomDescription: "很難令人相信。",
                idiomImageName: "2026_day251"
            ),

            "09-09": LunarCalendarData(
                lunarTerm: "廿八",
                suitableActivities: "宜嫁娶、出行",
                unsuitableActivities: "忌伐木、作灶",
                idiom: "三顧茅廬",
                idiomDescription: "比喻對人才真心誠意地邀請或拜訪。",
                idiomImageName: "2026_day252"
            ),

            "09-10": LunarCalendarData(
                lunarTerm: "廿九",
                suitableActivities: "宜開市、交易",
                unsuitableActivities: "忌作灶、理髮",
                idiom: "鬼門關",
                idiomDescription: "代表鬼月已經過去，不說「再見」、「留」等字眼，別讓好兄弟以為你要把他留下來。",
                idiomImageName: "2026_day253"
            ),
            ...
            "09-11": LunarCalendarData(
                ...
                unsuitableActivities: "忌安床、安葬",
                idiom: "排山倒海",
                idiomDescription: "推開高山，翻倒大海。形容力量強盛，聲勢浩大。",
                idiomImageName: "2026_day254"
            ),

            "09-12": LunarCalendarData(
                lunarTerm: "初二",
                suitableActivities: "宜嫁娶、認養",
                unsuitableActivities: "忌開市、安機",
                idiom: "玩命關頭",
                idiomDescription: "是一系列以街頭賽車、動作和家庭為主題的美國動作片。 以驚險刺激的飆車場面、精彩的動作戲和對家人朋友之間的情感描寫而聞名。",
                idiomImageName: "2026_day255"
            ),

            "09-13": LunarCalendarData(
                lunarTerm: "初三",
                suitableActivities: "宜解除、壞垣",
                unsuitableActivities: "忌牧養、安香",
                idiom: "金盆洗手",
                idiomDescription: "指舊時江湖人物宣布退隱江湖，不再參與相關事務的儀式。象徵著決心的堅定，以此告別過去的身份和活動。",
                idiomImageName: "2026_day256"
            ),
            ...
            "09-14": LunarCalendarData(
                ...
                idiom: "滄海一粟",
                idiomDescription: "大海中的一粒粟米，比喻渺小，微不足道。",
                idiomImageName: "2026_day257"
            ),

            "09-15": LunarCalendarData(
                lunarTerm: "初五",
                suitableActivities: "宜出行、理髮",
                unsuitableActivities: "忌開市、掘井",
                idiom: "飛黃騰達",
                idiomDescription: "指人得到快速的升遷，在仕途或事業上快速得志，取得成功。",
                idiomImageName: "2026_day258"
            ),

            "09-16": LunarCalendarData(
                lunarTerm: "初六",
                suitableActivities: "宜交易、納財",
                unsuitableActivities: "忌嫁娶、破土",
                idiom: "龜兔賽跑",
                idiomDescription: "出自《伊索寓言》，寓意著驕傲必敗，勤奮不懈終能成功。",
                idiomImageName: "2026_day259"
            ),
            ...
            "09-17": LunarCalendarData(
                ...
                idiom: "道德兩難",
                idiomDescription: "當人在兩種或兩種以上互相衝突價值的情況之下，面臨難以選擇的局面，當事人很難決定該採取或表現哪種行為，或該下哪種決定。",
                idiomImageName: "2026_day260"
            ),

            "09-18": LunarCalendarData(
                lunarTerm: "初八",
                suitableActivities: "宜祭祀、修墳",
                unsuitableActivities: "忌受死",
                idiom: "無法無天",
                idiomDescription: "既沒有法律約束，也不顧及天理良知，形容人肆意妄為，毫無顧忌。",
                idiomImageName: "2026_day261"
            ),

            "09-19": LunarCalendarData(
                lunarTerm: "初九",
                suitableActivities: "宜嫁娶、沐浴",
                unsuitableActivities: "忌祈福、開光",
                idiom: "枕戈待旦",
                idiomDescription: "枕著武器等待天明。形容人全神戒備，絲毫不敢鬆懈。",
                idiomImageName: "2026_day262"
            ),
            ...
            "09-20": LunarCalendarData(
                ...
                idiom: "柚香覺醒",
                idiomDescription: "將新鮮葡萄柚汁搭配輕焙烏龍茶王307，以清爽的口感和柚子香氣聞名。",
                idiomImageName: "2026_day263"
            ),

            "09-21": LunarCalendarData(
                lunarTerm: "十一",
                suitableActivities: "宜出行、求醫",
                unsuitableActivities: "忌造廟、安葬",
                idiom: "狡兔三窟",
                idiomDescription: "比喻有多處藏身的地方或多種避禍的準備。",
                idiomImageName: "2026_day264"
            ),
            ...
            "09-26": LunarCalendarData(
                ...
                idiom: "電力不足",
                idiomDescription: "指電力供應無法滿足用電需求的情況。",
                idiomImageName: "2026_day269"
            ),

            "09-27": LunarCalendarData(
                lunarTerm: "十七",
                suitableActivities: "宜出行、認養",
                unsuitableActivities: "忌開市、開倉",
                idiom: "舉足輕重",
                idiomDescription: "一舉腳就會影響兩邊的輕重。形容所居地位極為重要，一舉一動皆足以影響全局。",
                idiomImageName: "2026_day270"
            ),
            ...
            "10-02": LunarCalendarData(
                ...
                idiom: "日出而作",
                idiomDescription: "古人的生活方式，是說太陽一出來便開始一天的工作。",
                idiomImageName: "2026_day275"
            ),

            "10-03": LunarCalendarData(
                lunarTerm: "廿三",
                suitableActivities: "宜出行、入宅",
                unsuitableActivities: "忌針灸、伐木",
                idiom: "同舟共濟",
                idiomDescription: "指坐同一艘船渡河，比喻同心協力，共同戰勝困難。",
                idiomImageName: "2026_day276"
            ),

            "10-04": LunarCalendarData(
                lunarTerm: "廿四",
                suitableActivities: "宜出行、開市",
                unsuitableActivities: "忌安葬、動土",
                idiom: "蠟燭兩頭燒",
                idiomDescription: "形容一個人從早到晚不停工作，過度消耗體力，導致身心俱疲。",
                idiomImageName: "2026_day277"
            ),
            ...
            "10-09": LunarCalendarData(
                ...
                idiom: "如釋重負",
                idiomDescription: "形容責任已盡，身心輕鬆愉快，就像放下重擔一樣。",
                idiomImageName: "2026_day282"
            ),

            "10-10": LunarCalendarData(
                lunarTerm: "九月",
                suitableActivities: "宜納財、會友",
                unsuitableActivities: "忌作灶、伐木",
                idiom: "時來運轉",
                idiomDescription: "指本來處境不好，遇到好機會，從逆境轉為順境。",
                idiomImageName: "2026_day283"
            ),

            "10-11": LunarCalendarData(
                lunarTerm: "初二",
                suitableActivities: "宜出行、入宅",
                unsuitableActivities: "忌伐木、置產",
                idiom: "瑪利歐",
                idiomDescription: "是一位義大利裔美國人，職業是水管工，性格外向、自信且富有正義感。",
                idiomImageName: "2026_day284"
            ),
            ...
            "10-13": LunarCalendarData(
                ...
                idiom: "剖蚌求珠",
                idiomDescription: "將蚌殼剖開，取出裡面的珍珠，比喻求取賢良的人才或珍貴的物品。",
                idiomImageName: "2026_day286"
            ),

            "10-14": LunarCalendarData(
                lunarTerm: "初五",
                suitableActivities: "宜祈福、動土",
                unsuitableActivities: "忌開光、栽種",
                idiom: "響徹雲霄",
                idiomDescription: "指聲音非常響亮，好像可以穿透雲層，直達高空。",
                idiomImageName: "2026_day287"
            ),
            ...
            "10-15": LunarCalendarData(
                ...
                idiom: "沙發衝浪",
                idiomDescription: "Couchsurfing 是一種旅行方式，指透過網絡平台，免費借住在當地人家裡，與屋主交流，體驗當地生活。",
                idiomImageName: "2026_day288"
            ),

            "10-16": LunarCalendarData(
                lunarTerm: "初七",
                suitableActivities: "宜理髮、伐木",
                unsuitableActivities: "忌嫁娶、安葬",
                idiom: "山道猴子",
                idiomDescription: "一詞源於台灣機車文化，指的是那些在山路上飆車、追求速度與刺激的騎士，且常伴隨著改裝車輛和不守規矩的行為。",
                idiomImageName: "2026_day289"
            ),

            "10-17": LunarCalendarData(
                lunarTerm: "初八",
                suitableActivities: "宜會友、理髮",
                unsuitableActivities: "忌開市、入宅",
                idiom: "不眠不休",
                idiomDescription: "不睡覺不休息，不停的做某事。形容十分辛勞。",
                idiomImageName: "2026_day290"
            ),
            ...
            "10-19": LunarCalendarData(
                ...
                idiom: "騰雲駕霧",
                idiomDescription: "指在空中飛行，也可比喻奔馳疾速。",
                idiomImageName: "2026_day292"
            ),

            "10-20": LunarCalendarData(
                lunarTerm: "十一",
                suitableActivities: "宜嫁娶、祭祀",
                unsuitableActivities: "忌入宅、理髮",
                idiom: "熟能生巧",
                idiomDescription: "只要做事熟練了，自然就能領悟到其中的巧妙方法。",
                idiomImageName: "2026_day293"
            ),
            ...
            "10-21": LunarCalendarData(
                ...
                idiom: "絞盡腦汁",
                idiomDescription: "形容費盡心思，想盡辦法。",
                idiomImageName: "2026_day294"
            ),

            "10-22": LunarCalendarData(
                lunarTerm: "十三",
                suitableActivities: "宜認養、會友",
                unsuitableActivities: "忌祈福、訂盟",
                idiom: "摩西分海",
                idiomDescription: "位於澎湖縣湖西鄉北寮村，在這裡可以看見因潮汐現象所產生的分海奇觀，退潮時會在海中央出現一條蜿蜒的道路，可通往對岸的小島嶼。",
                idiomImageName: "2026_day295"
            ),

            "10-23": LunarCalendarData(
                lunarTerm: "霜降",
                suitableActivities: "宜交易、出行",
                unsuitableActivities: "忌探病、伐木",
                idiom: "拍案叫絕",
                idiomDescription: "拍桌子叫好，形容非常讚賞或感嘆。",
                idiomImageName: "2026_day296"
            ),
            ...
            "10-24": LunarCalendarData(
                ...
                idiom: "一箭雙鵰",
                idiomDescription: "比喻一次舉動，可以同時達成兩個目標。",
                idiomImageName: "2026_day297"
            ),

            "10-25": LunarCalendarData(
                lunarTerm: "十六",
                suitableActivities: "宜出行、入學",
                unsuitableActivities: "忌安門、安床",
                idiom: "翻山越嶺",
                idiomDescription: "形容長途跋涉，旅途艱辛。",
                idiomImageName: "2026_day298"
            ),

            "10-26": LunarCalendarData(
                lunarTerm: "十七",
                suitableActivities: "宜嫁娶、裁衣",
                unsuitableActivities: "忌開市、出行",
                idiom: "撒手人寰",
                idiomDescription: "描述人去世，有時候會用在比較文雅的語境中。",
                idiomImageName: "2026_day299"
            ),

            "10-27": LunarCalendarData(
                lunarTerm: "十八",
                suitableActivities: "宜祭祀、出行",
                unsuitableActivities: "忌出貨、動土",
                idiom: "愛不釋手",
                idiomDescription: "喜歡得捨不得放下，形容非常喜愛某物，愛不忍釋。",
                idiomImageName: "2026_day300"
            ),
            ...
            "10-28": LunarCalendarData(
                ...
                idiom: "關於小熊",
                idiomDescription: "是蛋堡於 2009 年發行的經典饒舌歌曲，描寫青春愛情的遺憾與回憶。",
                idiomImageName: "2026_day301"
            ),

            "10-29": LunarCalendarData(
                lunarTerm: "廿十",
                suitableActivities: "宜會友、出貨",
                unsuitableActivities: "忌入宅、出火",
                idiom: "扭轉乾坤",
                idiomDescription: "喻將現有的或不利的局勢作非常大的轉變。",
                idiomImageName: "2026_day302"
            ),
            ...
            "10-31": LunarCalendarData(
                ...
                unsuitableActivities: "忌受死",
                idiom: "瓜田李下",
                idiomDescription: "比喻容易引起嫌疑的場合。",
                idiomImageName: "2026_day304"
            ),
            ...
            "11-02": LunarCalendarData(
                ...
                idiom: "搭順風車",
                idiomDescription: "搭乘他人車輛，順路前往目的地，通常是免費或分攤部分油費的交通方式。",
                idiomImageName: "2026_day306"
            ),

            "11-03": LunarCalendarData(
                lunarTerm: "廿五",
                suitableActivities: "宜訂盟、會友",
                unsuitableActivities: "忌嫁娶、開市",
                idiom: "斷尾求生",
                idiomDescription: "在困境中，為了保全整體，而不得不犧牲一部分，以求生存的策略。",
                idiomImageName: "2026_day307"
            ),
            ...
            "11-04": LunarCalendarData(
                ...
                idiom: "任重道遠",
                idiomDescription: "指責任重大，要走的路途也漫長遙遠。",
                idiomImageName: "2026_day308"
            ),

            "11-05": LunarCalendarData(
                lunarTerm: "廿七",
                suitableActivities: "宜納財、捕捉",
                unsuitableActivities: "忌動土、安葬",
                idiom: "命在旦夕",
                idiomDescription: "指生命危在旦夕，隨時可能死去。",
                idiomImageName: "2026_day309"
            ),
            ...
            "11-06": LunarCalendarData(
                ...
                idiom: "木馬屠城",
                idiomDescription: "出自古希臘神話故事，特洛伊戰爭中，希臘聯軍久攻特洛伊不下，便用木馬計攻破城池。",
                idiomImageName: "2026_day310"
            ),

            "11-07": LunarCalendarData(
                lunarTerm: "立冬",
                suitableActivities: "宜解除",
                unsuitableActivities: "忌祭祀、求嗣",
                idiom: "初來乍到",
                idiomDescription: "剛剛來到某個地方，表示對環境、事物還不熟悉，或者還沒有適應的階段。",
                idiomImageName: "2026_day311"
            ),
            ...
            "11-08": LunarCalendarData(
                ...
                idiom: "印度咖哩",
                idiomDescription: "以濃厚的香料組合和多層次的味道著稱，常用的香料包括薑黃、孜然、香菜籽和辣椒，口味通常也較為辛辣和濃稠。",
                idiomImageName: "2026_day312"
            ),

            "11-09": LunarCalendarData(
                lunarTerm: "十月",
                suitableActivities: "宜祭祀、沐浴",
                unsuitableActivities: "忌行喪、開市",
                idiom: "浩劫重生",
                idiomDescription: "美國災難劇情片，內容講述聯邦快遞公司一名員工在南太平洋上空遇難墜機流浪到荒島的故事。",
                idiomImageName: "2026_day313"
            ),
            ...
            "11-11": LunarCalendarData(
                ...
                idiom: "張冠李戴",
                idiomDescription: "喻名實不符，弄錯對象。",
                idiomImageName: "2026_day315"
            ),

            "11-12": LunarCalendarData(
                lunarTerm: "初四",
                suitableActivities: "宜出行、交易",
                unsuitableActivities: "忌祈福、祭祀",
                idiom: "不二法門",
                idiomDescription: "是一個佛教術語，原指到達絕對真理的方法，後引申為唯一的方法或途徑。",
                idiomImageName: "2026_day316"
            ),
            ...
            "11-13": LunarCalendarData(
                ...
                idiom: "美夢成真",
                idiomDescription: "心中的想望在現實生活中實現。",
                idiomImageName: "2026_day317"
            ),

            "11-14": LunarCalendarData(
                lunarTerm: "初六",
                suitableActivities: "宜理髮、針灸",
                unsuitableActivities: "忌動土、入宅",
                idiom: "欲哭無淚",
                idiomDescription: "指想哭卻哭不出來，形容極度哀傷或無奈的狀態。",
                idiomImageName: "2026_day318"
            ),
            ...
            "11-15": LunarCalendarData(
                ...
                idiom: "星星之火",
                idiomDescription: "比喻事物微小但有發展的潛力，也指事情的開端很小，卻可能發展成巨大的局面。",
                idiomImageName: "2026_day319"
            ),

            "11-16": LunarCalendarData(
                lunarTerm: "初八",
                suitableActivities: "宜納采、訂盟",
                unsuitableActivities: "忌上樑、出貨",
                idiom: "青竹丹楓",
                idiomDescription: "指代南北兩地，也常用來表示朋友、家人或戀人之間的離別，因為分別後可能去往不同的地方。",
                idiomImageName: "2026_day320"
            ),
            ...
            "11-18": LunarCalendarData(
                ...
                idiom: "眉開眼笑",
                idiomDescription: "形容非常高興和喜悅的樣子。",
                idiomImageName: "2026_day322"
            ),

            "11-19": LunarCalendarData(
                lunarTerm: "十一",
                suitableActivities: "宜祈福、出行",
                unsuitableActivities: "忌伐木、理髮",
                idiom: "曇花一現",
                idiomDescription: "比喻人或事物一出現就很快消失，就像曇花開花時間很短暫一樣。",
                idiomImageName: "2026_day323"
            ),

            "11-20": LunarCalendarData(
                lunarTerm: "十二",
                suitableActivities: "宜合帳、嫁娶",
                unsuitableActivities: "忌置產、開光",
                idiom: "待價而沽",
                idiomDescription: "形容商品等待買家出高價購買。",
                idiomImageName: "2026_day324"
            ),
            ...
            "11-21": LunarCalendarData(
                ...
                idiom: "膠囊列車",
                idiomDescription: "釜山海雲台藍線公園內的一種特色觀光列車，行駛於尾浦站和青沙浦站之間，以高架方式運行，提供獨特的觀景體驗。",
                idiomImageName: "2026_day325"
            ),

            "11-22": LunarCalendarData(
                lunarTerm: "小雪",
                suitableActivities: "宜祈福、出行",
                unsuitableActivities: "忌作灶、經絡",
                idiom: "棄若敝屣",
                idiomDescription: "像丟棄破鞋一樣地拋棄，比喻毫不在意或毫不珍惜。",
                idiomImageName: "2026_day326"
            ),
            ...
            "11-23": LunarCalendarData(
                ...
                idiom: "飛簷走壁",
                idiomDescription: "形容身手矯健、武技高超。",
                idiomImageName: "2026_day327"
            ),

            "11-24": LunarCalendarData(
                lunarTerm: "十六",
                suitableActivities: "宜出行、納財",
                unsuitableActivities: "忌造廟、作灶",
                idiom: "心曠神怡",
                idiomDescription: "心胸開闊，精神愉快。",
                idiomImageName: "2026_day328"
            ),
            ...
            "11-28": LunarCalendarData(
                ...
                idiom: "一掃而空",
                idiomDescription: "形容某物被完全拿走或消耗殆盡。",
                idiomImageName: "2026_day332"
            ),

            "11-29": LunarCalendarData(
                lunarTerm: "廿一",
                suitableActivities: "宜會友、祭祀",
                unsuitableActivities: "忌嫁娶、出火",
                idiom: "溜之大吉",
                idiomDescription: "形容人為了避免麻煩、責任或不利的情況，而選擇悄悄離開，不告而別。",
                idiomImageName: "2026_day333"
            ),
            ...
            "11-30": LunarCalendarData(
                ...
                idiom: "招財貓咪",
                idiomDescription: "來自日本的吉祥物，象徵著招來財運和好運。",
                idiomImageName: "2026_day334"
            ),

            "12-01": LunarCalendarData(
                lunarTerm: "廿三",
                suitableActivities: "宜開市、出行",
                unsuitableActivities: "忌咦徙、入宅",
                idiom: "獨占鰲頭",
                idiomDescription: "在競賽中獲得第一名。",
                idiomImageName: "2026_day335"
            ),

            "12-02": LunarCalendarData(
                lunarTerm: "廿四",
                suitableActivities: "宜祭祀、理髮",
                unsuitableActivities: "忌入宅、安床",
                idiom: "夕陽西下",
                idiomDescription: "比喻人到老年，或事物走向衰落。",
                idiomImageName: "2026_day336"
            ),
            ...
            "12-03": LunarCalendarData(
                ...
                unsuitableActivities: "忌開市、動土",
                idiom: "洗眉刷目",
                idiomDescription: "比喻清晰明白。它出自清代史學家王鳴盛對歐陽修史書的評價，認為其內容簡略但能提綱挈領、條理分明，因此用「洗眉刷目」來形容其敘述精練的風格。",
                idiomImageName: "2026_day337"
            ),

            "12-04": LunarCalendarData(
                lunarTerm: "廿六",
                suitableActivities: "宜出行、會友",
                unsuitableActivities: "忌開市、納采",
                idiom: "顛倒是非",
                idiomDescription: "歪曲事實，混淆黑白。",
                idiomImageName: "2026_day338"
            ),

            "12-05": LunarCalendarData(
                lunarTerm: "廿七",
                suitableActivities: "宜會友、塞穴",
                unsuitableActivities: "忌嫁娶、開市",
                idiom: "火海刀山",
                idiomDescription: "比喻極其危險和困難的地方。",
                idiomImageName: "2026_day339"
            ),

            "12-06": LunarCalendarData(
                lunarTerm: "廿八",
                suitableActivities: "宜入宅、修造",
                unsuitableActivities: "忌開倉、蓋屋",
                idiom: "蠶食鯨吞",
                idiomDescription: "像蠶吃桑葉般和緩，像鯨魚吞食般猛烈，比喻不同的侵略併吞方式。",
                idiomImageName: "2026_day340"
            ),
            ...
            "12-07": LunarCalendarData(
                ...
                unsuitableActivities: "忌受死",
                idiom: "粉身碎骨",
                idiomDescription: "身體粉碎而死。比喻為了某種目的或遭到什麽危險而喪失生命。",
                idiomImageName: "2026_day341"
            ),
            ...
            "12-08": LunarCalendarData(
                ...
                idiom: "昏昏欲睡",
                idiomDescription: "形容人非常疲倦，提不起精神。",
                idiomImageName: "2026_day342"
            ),

            "12-09": LunarCalendarData(
                lunarTerm: "十一月",
                suitableActivities: "宜祭祀、解除",
                unsuitableActivities: "忌行喪、安機",
                idiom: "奉公守法",
                idiomDescription: "形容人行為端正，遵守規矩。",
                idiomImageName: "2026_day343"
            ),
            ...
            "12-13": LunarCalendarData(
                ...
                idiom: "冰天雪地",
                idiomDescription: "形容非常寒冷的地方。",
                idiomImageName: "2026_day347"
            ),

            "12-14": LunarCalendarData(
                lunarTerm: "初六",
                suitableActivities: "宜祭祀、祈福",
                unsuitableActivities: "忌嫁娶、認養",
                idiom: "十大奇景",
                idiomDescription: "指世界或特定地區最著名、最引人入勝的自然或人文景觀。",
                idiomImageName: "2026_day348"
            ),
            ...
            "12-23": LunarCalendarData(
                lunarTerm: "十五",
                suitableActivities: "宜安床、出行",
                unsuitableActivities: "忌作灶、安門",
                idiom: "陰陽交錯",
                idiomDescription: "比喻各種偶然因素湊在一起所造成的誤會。",
                idiomImageName: "2026_day357"
            ),
            ...
            "12-24": LunarCalendarData(
                ...
                idiom: "外送到府",
                idiomDescription: "把商品或餐點直接送到你家門口。",
                idiomImageName: "2026_day358"
            ),

            "12-25": LunarCalendarData(
                lunarTerm: "十七",
                suitableActivities: "宜沐浴、理髮",
                unsuitableActivities: "忌會友、安葬",
                idiom: "聖誕快樂",
                idiomDescription: "Merry Christmas!",
                idiomImageName: "2026_day359"
            ),

            "12-26": LunarCalendarData(
                lunarTerm: "十八",
                suitableActivities: "宜納采、訂盟",
                unsuitableActivities: "忌認養、赴任",
                idiom: "金銀斧頭",
                idiomDescription: "意著誠實的美德和意外的收穫。",
                idiomImageName: "2026_day360"
            ),

            "12-27": LunarCalendarData(
                lunarTerm: "十九",
                suitableActivities: "宜入宅、出行",
                unsuitableActivities: "忌嫁娶、開市",
                idiom: "山珍海味",
                idiomDescription: "指各種豐盛美味的菜餚。",
                idiomImageName: "2026_day361"
            ),

            "12-28": LunarCalendarData(
                lunarTerm: "廿十",
                suitableActivities: "宜畜稠、馴畜",
                unsuitableActivities: "忌入宅、分居",
                idiom: "草莓大福",
                idiomDescription: "冬季限定的甜點，因其酸甜多汁的草莓和綿軟的麻糬外皮而受到喜愛。",
                idiomImageName: "2026_day362"
            ),
            ...
            "12-29": LunarCalendarData(
                ...
                idiom: "暢行無阻",
                idiomDescription: "非常順利地通行，沒有任何阻礙。",
                idiomImageName: "2026_day363"
            ),

            "12-30": LunarCalendarData(
                lunarTerm: "廿二",
                suitableActivities: "宜訂盟、開光",
                unsuitableActivities: "忌祈福、動土",
                idiom: "自由女神",
                idiomDescription: "是美國的象徵，同時也是自由、民主、和希望的象徵。",
                idiomImageName: "2026_day364"
            ),
...
extension LunarCalendarDataManager {
    /// 取得當前年份的資料統計
    func getYearStatistics(for year: Int) -> (totalDays: Int, hasData: Int, missingData: Int) {
        guard let yearData = calendarData[year] else {
            return (0, 0, 0)
        }
        ...
        let hasData = yearData.count
        let missingData = totalDays - hasData
        
        return (totalDays, hasData, missingData)
    }
}
