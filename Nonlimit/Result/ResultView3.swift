...
struct ResultView3: View {
    ...
    let bundles: [ImageTextBundle3] = [
        ImageTextBundle3(imageName: "drink", text: "船到橋頭自然直"),
        ImageTextBundle3(imageName: "spring", text:"放下它"),
        ImageTextBundle3(imageName: "trash", text: "相信自己的直覺")
    ]
