...
struct ResultView2: View {
    ...
    let bundles: [ImageTextBundle2] = [
        ImageTextBundle2(imageName: "drink", text: "退一步海闊天空"),
        ImageTextBundle2(imageName: "spring", text:"無所畏懼"),
        ImageTextBundle2(imageName: "trash", text: "專注呼吸就好")
    ]
